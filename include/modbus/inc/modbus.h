...
public:
  ...
  */
  ...
  uint8_t readCoils(uint8_t slaveId, uint16_t, uint16_t);
  ...
  uint8_t writeSingleRegister(uint8_t slaveId, uint16_t, uint16_t);
  uint8_t writeSingleRegister(uint16_t, uint16_t);
  uint8_t writeMultipleCoils(uint8_t slaveId, uint16_t, uint16_t);
  uint8_t writeMultipleCoils(uint16_t, uint16_t);
  uint8_t writeMultipleCoils(uint8_t slaveId);
  uint8_t writeMultipleCoils();
  uint8_t writeMultipleRegisters(uint8_t slaveId, uint16_t, uint16_t);
  uint8_t writeMultipleRegisters(uint16_t, uint16_t);
  uint8_t writeMultipleRegisters(uint8_t slaveId);
  uint8_t writeMultipleRegisters();
  uint8_t maskWriteRegister(uint8_t slaveId, uint16_t, uint16_t, uint16_t);
  uint8_t maskWriteRegister(uint16_t, uint16_t, uint16_t);
  uint8_t readWriteMultipleRegisters(uint8_t slaveId, uint16_t, uint16_t, uint16_t, uint16_t);
...
private:
  ...
  uint8_t ModbusMasterTransaction(uint8_t slaveId, uint8_t u8MBFunction);
