...
public:
     ...
     */
    SunspecModelReader(const SunspecModelDefWrapper &def, uint16_t *modbusBuffer, const uint16_t address, SunspecDeviceReader &device);
     ...
     * @return Reference to SunspecModelDefWrapper
     */
