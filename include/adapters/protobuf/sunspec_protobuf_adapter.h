...
inline sint16_t FormatSunspecPointDefToSint16_t(const SunspecPointDef &def)
{
    ...
    return {sint16.has_sint16() ? static_cast<sint16_t>(sint16.sint16()) : kSint16UnimplementedValue};
}

inline raw16_t FormatSunspecPointDefTotoRaw16_t(const SunspecPointDef &def)
{
    const SunspecPointData &raw16 = def.data();
    return {raw16.has_raw16() ? static_cast<raw16_t>(raw16.raw16()) : kRaw16UnimplementedValue};
}
...
inline bitfield16_t FormatSunspecPointDefToBit16_t(const SunspecPointDef &def)
{
    ...
    return {bit16.has_bitfield16() ? static_cast<bitfield16_t>(bit16.bitfield16()) : kBit16UnimplementedValue};
}

inline acc16_t FormatSunspecPointDefToAcc16_t(const SunspecPointDef &def)
{
    const SunspecPointData &acc16 = def.data();
    return {acc16.has_acc16() ? static_cast<acc16_t>(acc16.acc16()) : kAcc16UnimplementedValue};
}

inline enum16_t FormatSunspecPointDefToEnum16_t(const SunspecPointDef &def)
{
    const SunspecPointData &enum16 = def.data();
    return {enum16.has_enum16() ? static_cast<enum16_t>(enum16.enum16()) : kEnum16UnimplementedValue};
}
...
inline sunsSf_t FormatSunspecPointDefToSunsSf_t(const SunspecPointDef &def)
{
    ...
    return {sunsSf.has_sunssf() ? static_cast<sunsSf_t>(sunsSf.sunssf()) : kSunsSfUnimplementedValue};
}
