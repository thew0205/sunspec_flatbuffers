...
void CheckGroup(const SunspecGroupPointDef &group, const std::string &id, SunspecGroupType type, uint16_t count, const std::string &count_point_id, uint16_t pointLength, uint16_t groupLength);
