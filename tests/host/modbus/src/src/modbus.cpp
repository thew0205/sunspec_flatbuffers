...
@ingroup discrete
*/
uint8_t ModbusMaster::readCoils(uint8_t slaveId, uint16_t u16ReadAddress, uint16_t u16BitQty)
{
  setSlaveId(slaveId);
...
@ingroup discrete
*/
uint8_t ModbusMaster::readDiscreteInputs(uint8_t slaveId, uint16_t u16ReadAddress,
                                         uint16_t u16BitQty)
{
  setSlaveId(slaveId);
...
@ingroup register
*/
uint8_t ModbusMaster::readHoldingRegisters(uint8_t slaveId, uint16_t u16ReadAddress,
                                           uint16_t u16ReadQty)
{
  setSlaveId(slaveId);
...
@ingroup register
*/
uint8_t ModbusMaster::readInputRegisters(uint8_t slaveId, uint16_t u16ReadAddress,
                                         uint8_t u16ReadQty)
{
  setSlaveId(slaveId);
...
@ingroup discrete
*/
uint8_t ModbusMaster::writeSingleCoil(uint8_t slaveId, uint16_t u16WriteAddress, uint8_t u8State)
{
  setSlaveId(slaveId);
...
@ingroup register
*/
uint8_t ModbusMaster::writeSingleRegister(uint8_t slaveId, uint16_t u16WriteAddress,
...
@ingroup discrete
*/
uint8_t ModbusMaster::writeMultipleCoils(uint8_t slaveId, uint16_t u16WriteAddress,
                                         uint16_t u16BitQty)
{
  setSlaveId(slaveId);
...
uint8_t ModbusMaster::writeMultipleCoils(uint8_t slaveId)
{
  setSlaveId(slaveId);
...
@ingroup register
*/
uint8_t ModbusMaster::writeMultipleRegisters(uint8_t slaveId, uint16_t u16WriteAddress,
...
uint8_t ModbusMaster::writeMultipleRegisters(uint8_t slaveId)
{
  setSlaveId(slaveId);
...
@ingroup register
*/
uint8_t ModbusMaster::maskWriteRegister(uint8_t slaveId, uint16_t u16WriteAddress,
...
@ingroup register
*/
uint8_t ModbusMaster::readWriteMultipleRegisters(uint8_t slaveId, uint16_t u16ReadAddress,
...
@return 0 on success; exception number on failure
*/
uint8_t ModbusMaster::ModbusMasterTransaction(uint8_t slaveId, uint8_t u8MBFunction)
{
  setSlaveId(slaveId);
  return ModbusMasterTransaction(u8MBFunction);
}
  ...
  if (!u8MBStatus)
  {
    ...
    case ku8MBReadDiscreteInputs:
      ...
      for (i = 0; i < (u8ModbusADU[2] >> 1); i++)
      {
        ...
        {
          _u16ResponseBuffer[i] = (uint16_t)(u8ModbusADU[2 * i + 4] << 8 | u8ModbusADU[2 * i + 3]);
        }
    ...
    case ku8MBReadWriteMultipleRegisters:
      ...
      for (i = 0; i < (u8ModbusADU[2] >> 1); i++)
      {
        if (i < ku8MaxBufferSize)
        {
          _u16ResponseBuffer[i] = (uint16_t)(u8ModbusADU[2 * i + 3] << 8 | u8ModbusADU[2 * i + 4]);
        }
